...
class Category(models.Model):
    ...
    menu_monday = models.BooleanField(default=False)
    menu_tuesday = models.BooleanField(default=False)
    menu_wednesday = models.BooleanField(default=False)
    menu_thursday = models.BooleanField(default=False)
    menu_friday = models.BooleanField(default=False)
    complex_delivery = models.BooleanField(default=False)
    vip_delivery = models.BooleanField(default=False)
    banket_delivery = models.BooleanField(default=False)
    children_delivery = models.BooleanField(default=False)
...
class ShippingAddress(models.Model):
    ...
    date_added = models.DateTimeField(auto_now_add=True)
    status = models.CharField(max_length=300, choices = CHOICES, default='New')
